...
public class BossAI : MonsterAI
{
    ...
    {
        // BossAI fully controls movement; skip MonsterAI.FixedUpdate.
    }
    ...
    void MoveTowardsTarget()
    {
        ...
        Vector2 next = bossRb.position + dir * moveSpeed * Time.deltaTime;
    ...
    IEnumerator DoCharge()
    {
        ...
        Vector2 chargeDir = GetFacingDirection();
